...
ESD_TARGET_GRAPHICS(EVE_GRAPHICS_IDM2040_21R, DisplayName = "IDM2040-21R (BT883)", SupportedFlash = "(?=a)b", SupportedTouch = "\b\w+FOCAL\w*\b|\b\w+GOODIX\w*\b", IntegratedPlatform = "RP2040", LibraryTargets = "\b(FT81X|FT813)\b", FirmwareFolder = "-")

ESD_TARGET_GRAPHICS(EVE_GRAPHICS_STM32F4_21R, DisplayName = "STM32F4-21R (BT883)", SupportedFlash = "(?=a)b", SupportedTouch = "\b\w+FOCAL\w*\b|\b\w+GOODIX\w*\b", LibraryTargets = "\b(FT81X|FT813)\b", FirmwareFolder = "-")
...
ESD_TARGET_PLATFORM(EVE_PLATFORM_STM32, DisplayName = "STM32Cube", SupportedArchitectures = "\bSTM32\b")
...
*/
    ...
    || defined(EVE_GRAPHICS_IDM2040) || defined(EVE_GRAPHICS_STM32F4_21R)    \
    || defined(EVE_GRAPHICS_IDM2040_43A) || defined(EVE_GRAPHICS_IDM2040_21R)
...
#elif defined(EVE_GRAPHICS_VM816C) && defined(EVE_PLATFORM_STM32)
...
#elif defined(EVE_GRAPHICS_ME817EV) && defined(EVE_PLATFORM_STM32)
...
#elif defined(EVE_GRAPHICS_STM32F4_21R)
...
#if defined(FT9XX_PLATFORM) || (defined(RP2040_PLATFORM) && !defined(ENABLE_IDM2040_21R_RP2040)) || (defined(STM32_PLATFORM) && !defined(ENABLE_STM32F4_21R))
