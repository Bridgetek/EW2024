...
#define EVE_CS_ACTIVE()        { HAL_GPIO_WritePin(EVE_CS_GPIO_Port, EVE_CS_Pin, GPIO_PIN_RESET);}
#define EVE_CS_DEACTIVE()      { HAL_GPIO_WritePin(EVE_CS_GPIO_Port, EVE_CS_Pin, GPIO_PIN_SET);}
#ifdef __GNUC__
