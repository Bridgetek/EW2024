...
void Usr_BedroomLightPage__Initializer(Usr_BedroomLightPage *context)
{
	...
	context->LampColor = 0xffffffffUL;
...
typedef struct
{
	Usr_BedroomLightPage Instance;
} Usr_BedroomLightPage__ESD;


void *Usr_BedroomLightPage__Create__ESD()
{
	Usr_BedroomLightPage__ESD *context = (Usr_BedroomLightPage__ESD *)esd_malloc(sizeof(Usr_BedroomLightPage__ESD));
	if (context)
	{
		Usr_BedroomLightPage__Initializer(&context->Instance);
		context->Instance.Owner = context;
	}
	else
	{
		eve_printf_debug("Out of memory (Usr_BedroomLightPage__Create__ESD)");
	}
	return context;
}

void Usr_BedroomLightPage__Destroy__ESD(void *context)
{
	esd_free(context);
}

void Usr_BedroomLightPage__Set_SliderValue__ESD(void *context, int value) { ((Usr_BedroomLightPage__ESD *)context)->Instance.SliderValue = value; }
void Usr_BedroomLightPage__Set_LampColor__ESD(void *context, esd_argb32_t value) { ((Usr_BedroomLightPage__ESD *)context)->Instance.LampColor = value; }
void Usr_BedroomLightPage__Set_lampEffect__ESD(void *context, esd_argb32_t value) { ((Usr_BedroomLightPage__ESD *)context)->Instance.lampEffect = value; }
void Usr_BedroomLightPage__Set_On__ESD(void *context, bool value) { ((Usr_BedroomLightPage__ESD *)context)->Instance.On = value; }
