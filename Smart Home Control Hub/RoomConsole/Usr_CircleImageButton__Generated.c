...
typedef struct
{
	Usr_CircleImageButton Instance;
	ft_uint8_t MinAlpha;
	Ft_Esd_BitmapCell BitmapNormal;
} Usr_CircleImageButton__ESD;

ft_uint8_t Usr_CircleImageButton__Get_MinAlpha__ESD(void *context) { return ((Usr_CircleImageButton__ESD *)context)->MinAlpha; }
void Usr_CircleImageButton__Set_MinAlpha__ESD(void *context, ft_uint8_t value) { ((Usr_CircleImageButton__ESD *)context)->MinAlpha = value; }
Ft_Esd_BitmapCell Usr_CircleImageButton__Get_BitmapNormal__ESD(void *context) { return ((Usr_CircleImageButton__ESD *)context)->BitmapNormal; }
void Usr_CircleImageButton__Set_BitmapNormal__ESD(void *context, Ft_Esd_BitmapCell value) { ((Usr_CircleImageButton__ESD *)context)->BitmapNormal = value; }

void *Usr_CircleImageButton__Create__ESD()
{
	Usr_CircleImageButton__ESD *context = (Usr_CircleImageButton__ESD *)esd_malloc(sizeof(Usr_CircleImageButton__ESD));
	if (context)
	{
		Usr_CircleImageButton__Initializer(&context->Instance);
		context->Instance.Owner = context;
		context->MinAlpha = 1;
		context->Instance.MinAlpha = Usr_CircleImageButton__Get_MinAlpha__ESD;
		context->BitmapNormal = (Ft_Esd_BitmapCell){ 0 };
		context->Instance.BitmapNormal = Usr_CircleImageButton__Get_BitmapNormal__ESD;
	}
	else
	{
		eve_printf_debug("Out of memory (Usr_CircleImageButton__Create__ESD)");
	}
	return context;
}

void Usr_CircleImageButton__Destroy__ESD(void *context)
{
	esd_free(context);
}

void Usr_CircleImageButton__Set_Color__ESD(void *context, ft_argb32_t value) { ((Usr_CircleImageButton__ESD *)context)->Instance.Color = value; }
void Usr_CircleImageButton__Set_BackgroundColor__ESD(void *context, ft_argb32_t value) { ((Usr_CircleImageButton__ESD *)context)->Instance.BackgroundColor = value; }
void Usr_CircleImageButton__Set_BorderColor__ESD(void *context, ft_argb32_t value) { ((Usr_CircleImageButton__ESD *)context)->Instance.BorderColor = value; }
void Usr_CircleImageButton__Set_BorderWidth__ESD(void *context, int value) { ((Usr_CircleImageButton__ESD *)context)->Instance.BorderWidth = value; }
void Usr_CircleImageButton__Set_Align__ESD(void *context, uint8_t value) { ((Usr_CircleImageButton__ESD *)context)->Instance.Align = value; }
void Usr_CircleImageButton__Set_Scaling__ESD(void *context, uint8_t value) { ((Usr_CircleImageButton__ESD *)context)->Instance.Scaling = value; }
void Usr_CircleImageButton__Set_AutoResize__ESD(void *context, ft_uint8_t value) { ((Usr_CircleImageButton__ESD *)context)->Instance.AutoResize = value; }
void Usr_CircleImageButton__Set_ScaleX__ESD(void *context, ft_int32_f16_t value) { ((Usr_CircleImageButton__ESD *)context)->Instance.ScaleX = value; }
void Usr_CircleImageButton__Set_ScaleY__ESD(void *context, ft_int32_f16_t value) { ((Usr_CircleImageButton__ESD *)context)->Instance.ScaleY = value; }
